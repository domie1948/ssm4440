  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.taocanbianhao" label="套餐编号" prop="taocanbianhao">
              <el-input v-model="ruleForm.taocanbianhao" 
                placeholder="套餐编号" readonly></el-input>
          </el-form-item>
        </div>
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmian" label="封面" prop="fengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fengmian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="系列" prop="xilie">
          <el-select v-model="ruleForm.xilie" placeholder="请选择系列">
            <el-option
                v-for="(item,index) in xilieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="系列" prop="xilie">
	      <el-input v-model="ruleForm.xilie"
                placeholder="系列" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="标签" prop="biaoqian">
          <el-select v-model="ruleForm.biaoqian" placeholder="请选择标签">
            <el-option
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.biaoqian"
                placeholder="标签" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="套餐金额" prop="taocanjine">
          <el-input v-model="ruleForm.taocanjine" 
              placeholder="套餐金额" clearable  :readonly="ro.taocanjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="套餐金额" prop="taocanjine">
              <el-input v-model="ruleForm.taocanjine" 
                placeholder="套餐金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoqian = true;
            continue;
	            	            ...
	            	            if(o=='taocanjine'){
            this.ruleForm.taocanjine = obj[o];
	    this.ro.taocanjine = true;
            continue;
          }
	            	            if(o=='paishedidian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                ...
                                                                                                this.$http({
              url: `option/taocanxilie/xilie`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.xilieOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
         
                                        this.biaoqianOptions = "国内爆款,店长力荐,全新主题,明星同款,网红同款".split(',')
                                                                                                                      },
                                                                                        // 多级联动参数
                                                                                                                info(id) {
      this.$http({
        url: `sheyingtaocan/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.taocanxiangqing = this.ruleForm.taocanxiangqing.replace(reg,'../../../ssmyj1om/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `sheyingtaocan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.sheyingtaocanCrossAddOrUpdateFlag = false;
                  this.parent.search();
