  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="订单编号" prop="dingdanbianhao">
              <el-input v-model="ruleForm.dingdanbianhao" 
                placeholder="订单编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="套餐编号" prop="taocanbianhao">
          <el-input v-model="ruleForm.taocanbianhao" 
              placeholder="套餐编号" clearable  :readonly="ro.taocanbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="套餐编号" prop="taocanbianhao">
              <el-input v-model="ruleForm.taocanbianhao" 
                placeholder="套餐编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.fuwupingfen"
                placeholder="服务评分" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="技术评分" prop="jishupingfen">
          <el-select v-model="ruleForm.jishupingfen" placeholder="请选择技术评分">
            <el-option
                v-for="(item,index) in jishupingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="技术评分" prop="jishupingfen">
	      <el-input v-model="ruleForm.jishupingfen"
                placeholder="技术评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.shaitu" label="晒图" prop="shaitu">
          <file-upload
          tip="点击上传晒图"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.shaitu?ruleForm.shaitu:''"
          @change="shaituUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.shaitu" label="晒图" prop="shaitu">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shaitu.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                                                                                            ...
                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="整体评价" prop="zhengtipingjia">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="整体评价"
                  v-model="ruleForm.zhengtipingjia" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhengtipingjia" label="整体评价" prop="zhengtipingjia">
                    <span>{{ruleForm.zhengtipingjia}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fuwupingfen = true;
            continue;
	            	            ...
	            	            if(o=='jishupingfen'){
            this.ruleForm.jishupingfen = obj[o];
	    this.ro.jishupingfen = true;
            continue;
          }
	            	            if(o=='shaitu'){
            this.ruleForm.shaitu = obj[o];
	    this.ro.shaitu = true;
            continue;
          }
	            	            if(o=='zhengtipingjia'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                        ...
                                        this.jishupingfenOptions = "1,2,3,4,5".split(',')
                                                                                                                                        },
                                                                                                // 多级联动参数
                                                                                                                          info(id) {
      this.$http({
        url: `sheyingpingjia/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `sheyingpingjia/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.sheyingpingjiaCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                    ...
                                                                                    shaituUploadChange(fileUrls) {
                this.ruleForm.shaitu = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                        	addEditStyleChange() {
	  this.$nextTick(()=>{
