        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="摄影师" prop="sheyingshi">
          <el-input v-model="ruleForm.sheyingshi" 
              placeholder="摄影师" clearable  :readonly="ro.sheyingshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="摄影师" prop="sheyingshi">
              <el-input v-model="ruleForm.sheyingshi" 
                placeholder="摄影师" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="化妆师" prop="huazhuangshi">
          <el-input v-model="ruleForm.huazhuangshi" 
              placeholder="化妆师" clearable  :readonly="ro.huazhuangshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="化妆师" prop="huazhuangshi">
              <el-input v-model="ruleForm.huazhuangshi" 
                placeholder="化妆师" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='sheyingshi'){
            this.ruleForm.sheyingshi = obj[o];
	    this.ro.sheyingshi = true;
            continue;
          }
	            	            if(o=='huazhuangshi'){
            this.ruleForm.huazhuangshi = obj[o];
	    this.ro.huazhuangshi = true;
            continue;
          }
	                    }
                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `kepianxinshang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kepianxinshangCrossAddOrUpdateFlag = false;
                  this.parent.search();
